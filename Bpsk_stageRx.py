...
class Bpsk_stageRx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._freq_range = qtgui.Range(145e6, 155e6, 100e3, 150e6, 200)
        self._freq_win = qtgui.RangeWidget(self._freq_range, self.set_freq, "Frecuencia", "counter", float, QtCore.Qt.Horizontal)
        ...
        self.blocks_skiphead_0 = blocks.skiphead(gr.sizeof_char*1, 1024)
